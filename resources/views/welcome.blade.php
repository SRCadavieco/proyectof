...
>
    ...
    <div class="max-w-7xl mx-auto px-6 h-16 flex justify-between items-center">
        ...
        <div class="flex items-center gap-2">
            <img src="/images/logo-fabricai.svg" alt="FabricAI Logo" class="h-8 w-8">
            <span class="text-2xl font-bold bg-gradient-to-r from-purple-400 to-indigo-500 bg-clip-text text-transparent">FABRICAI</span>
        </div>
...
<section class="relative h-screen flex items-center justify-center text-center overflow-hidden">
    ...
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2
                w-[900px] h-[900px] bg-purple-600/10 blur-[150px] rounded-full">
    </div>
    ...
    >
        <h1 class="text-5xl sm:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
            Design Clothing with <br>
            <span class="text-purple-400">Artificial Intelligence</span>
        </h1>

        <p class="text-gray-300 text-lg sm:text-xl max-w-2xl mx-auto mb-10">
            Describe your idea and instantly generate unique fashion designs powered by AI.
        </p>
...
<!-- ================= CTA ================= -->
<section class="py-32 text-center bg-gray-950 border-t border-gray-800">
